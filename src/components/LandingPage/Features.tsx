        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            <CardContent sx={{ flexGrow: 1 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography sx={{ width: "90%" }}>(61) 3543-9342</Typography>
                <Button size="small">
                  <LocalPhone />
                </Button>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography sx={{ width: "90%" }}>(61) 99410-0485</Typography>
                <Button size="small">
                  <SmartphoneIcon />
                </Button>
              </Box>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            <CardContent sx={{ flexGrow: 1 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography sx={{ width: "90%" }}>Segunda a sexta</Typography>
                <Button size="small">
                  <CalendarMonthIcon />
                </Button>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography sx={{ width: "90%" }}>8h - 18h</Typography>
                <Button size="small">
                  <ScheduleIcon />
                </Button>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography sx={{ width: "90%" }}>12h - 14h</Typography>
                <Button size="small">
                  <RestaurantIcon />
                </Button>
              </Box>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            <CardContent sx={{ flexGrow: 1 }}>
              ...
              <Typography py={1}>Grande Colorado, Edifício Pontal</Typography>
              <Typography pb={1}>
                Condominio Solar de Athenas, Lotes 01/02
              </Typography>
              <Typography pb={1}>73015-903</Typography>
            </CardContent>
          </Card>
        </Grid>
